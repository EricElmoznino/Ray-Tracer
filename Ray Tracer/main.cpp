...
{
    // Check if we are actually trying to use the ray tracer for its
    // original intended purpose, or using it to generate training data
    // for a machine learning project
    if (argc == 2 && strcmp(argv[1], "ML") == 0) {
        return mainML();
    }
